...
export const PLANS: PlanInfo[] = [
  ...
  },
  {
    ...
    minutes: 120,
    features: ['ไม่มีลายน้ำ', 'วิดีโอ 1080p', 'ดาวน์โหลดโปรเจกต์ CapCut', 'ฟอนต์/เทมเพลต/SFX ครบ', 'คิวเรนเดอร์เร็วกว่า'],
    cta: 'อัปเกรดเป็น Pro',
    highlight: true,
  },
  {
    ...
    minutes: 500,
    features: ['ทุกอย่างใน Pro', 'วิดีโอ 4K', 'อัปหลายคลิปพร้อมกัน', 'ส่งออกไฟล์ต้นฉบับ', 'หลายบัญชีในทีม'],
